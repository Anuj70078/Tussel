      ...
      return (
        <ul className="navbar-nav">
          <li className="nav-item">
            <Link className="nav-link text-white" to="/admin/manageuser">
              Manage Users
            </Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link text-white" to="/admin/managecompetition">
              Manage Competition
            </Link>
          </li>
    ...
    <div>
      <nav className="navbar navbar-expand-lg navbar-light" style={{ backgroundColor: 'indigo' }}>
        <div className="container">
          <img src="https://cdn-icons-png.flaticon.com/512/708/708906.png" alt="" height={45} className="mx-1" />
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav">
              ...
              <li className="nav-item">
                <Link className="nav-link text-white" aria-current="page" to="/main/declaredResults">
                  Declared Results
                </Link>
              </li>
